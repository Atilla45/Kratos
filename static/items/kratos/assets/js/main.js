(function () {
    ...
    window.onscroll = function () {
        ...
        if (window.pageYOffset > sticky) { header_navbar.classList.add("sticky"); logo.src = 'items/kratos/assets/images/logo/logot.png'; button.style.color = "#1956c7" } else { header_navbar.classList.remove("sticky"); logo.src = 'items/kratos/assets/images/logo/logot.png'; }
